    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_gf', models.IntegerField()),
                ('dataset_id', models.CharField(db_index=True, max_length=60, null=True, blank=True)),
                ('institution_code', models.CharField(db_index=True, max_length=25, null=True, blank=True)),
                ('catalog_number', models.CharField(db_index=True, max_length=25, null=True, blank=True)),
                ('basis_of_record', models.CharField(db_index=True, max_length=25, null=True, blank=True)),
                ('scientific_name', models.CharField(db_index=True, max_length=100, null=True, blank=True)),
                ('kingdom', models.CharField(db_index=True, max_length=25, null=True, blank=True)),
